...
export class BenefitsManager {
  private static benefits: Benefit[] = [
  ...
  static getRandomBenefits(count: number): Benefit[] {
    const shuffled = [...this.benefits].sort(() => 0.5 - Math.random());
    return shuffled.slice(0, count);
  }

  static getAllBenefits(): Benefit[] {
    return [...this.benefits];
  }

  static getBenefitById(id: number): Benefit | undefined {
